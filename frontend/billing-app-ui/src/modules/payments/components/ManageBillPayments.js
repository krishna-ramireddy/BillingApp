...
import { TextField, MenuItem, Grid, Card, Box, Button, Backdrop, CircularProgress, ButtonGroup, Tooltip } from '@mui/material';
                ...
                <Card sx={{ width: '100%', m: 1, position: 'relative' }}>
                    <Box sx={{ width: '100%' }}>
                        <Box sx={{ textAlign: 'end', mt: 0.5 }}>
                            <Button variant='outlined' onClick={() => { setIsDialogOpen(true) }} startIcon={<AddCircleOutlineIcon />} sx={{ textTransform: 'none' }} >Add New Billing</Button>
                        </Box>
                        <TableContainer>
                            <Table
